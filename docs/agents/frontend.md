...
- Use `aria-label`, `accessibilityLabel`, and other accessible names on every interactive element, icon, and control that supports it whenever visible text is missing, ambiguous, or not present.
